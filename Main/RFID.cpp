...
void NFC_Loop(void) {
  ...
  if (success) {
    ...
    WriteNFCBlock(uid, uidLength, NFC_Sector_Need , data);
    data[0] = '1'; data[1] = '3'; data[2] = '9'; data[3] = '5'; data[4] = '/'; data[5] = '0'; data[6] = '2'; data[7] = '/'; data[8] = '0'; data[9] = '1';

    WriteNFCBlock(uid, uidLength, NFC_Sector_DATEStart , data);

    data[0] = '1'; data[1] = '3'; data[2] = '9'; data[3] = '5'; data[4] = '/'; data[5] = '0'; data[6] = '9'; data[7] = '/'; data[8] = '3'; data[9] = '0';

    WriteNFCBlock(uid, uidLength, NFC_Sector_DATEEnd , data);
    data[0] = 'F'; data[1] = 'I'; data[2] = 'N'; data[3] = 'I'; data[4] = 'S'; data[5] = 'H'; data[6] = 'D'; data[7] = 'A'; data[8] = 'T'; data[9] = 'A';
    ...
    if (data[0] == 'F' && data[1] == 'I' && data[2] == 'N' && data[3] == 'I' && data[4] == 'S' && data[5] == 'H' && data[6] == 'D' && data[7] == 'A' && data[8] == 'T' && data[9] == 'A' )
    {
      for (int i = 0; i < 10; i++) {
